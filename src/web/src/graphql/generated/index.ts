...
export type GetDepotsQuery = { __typename?: 'Query', depots: Array<{ __typename?: 'Depot', id: string, name: string, addressId: string, isActive: boolean, createdAt: string, updatedAt?: string | null, address?: { __typename?: 'Address', street1: string, street2?: string | null, city: string, state: string, postalCode: string, countryCode: string, isResidential: boolean, contactName?: string | null, companyName?: string | null, phone?: string | null, email?: string | null } | null, operatingHours?: Array<{ __typename?: 'OperatingHours', dayOfWeek: DayOfWeek, openTime?: string | null, closedTime?: string | null, isClosed: boolean }> | null }> };
...
export type GetDepotQuery = { __typename?: 'Query', depot?: { __typename?: 'Depot', id: string, name: string, addressId: string, isActive: boolean, createdAt: string, updatedAt?: string | null, address?: { __typename?: 'Address', street1: string, street2?: string | null, city: string, state: string, postalCode: string, countryCode: string, isResidential: boolean, contactName?: string | null, companyName?: string | null, phone?: string | null, email?: string | null } | null, operatingHours?: Array<{ __typename?: 'OperatingHours', dayOfWeek: DayOfWeek, openTime?: string | null, closedTime?: string | null, isClosed: boolean }> | null } | null };
...
export type CreateDepotMutation = { __typename?: 'Mutation', createDepot: { __typename?: 'Depot', id: string, name: string, addressId: string, isActive: boolean, createdAt: string, updatedAt?: string | null, address?: { __typename?: 'Address', street1: string, street2?: string | null, city: string, state: string, postalCode: string, countryCode: string, isResidential: boolean, contactName?: string | null, companyName?: string | null, phone?: string | null, email?: string | null } | null, operatingHours?: Array<{ __typename?: 'OperatingHours', dayOfWeek: DayOfWeek, openTime?: string | null, closedTime?: string | null, isClosed: boolean }> | null } };
...
export type UpdateDepotMutation = { __typename?: 'Mutation', updateDepot?: { __typename?: 'Depot', id: string, name: string, addressId: string, isActive: boolean, createdAt: string, updatedAt?: string | null, address?: { __typename?: 'Address', street1: string, street2?: string | null, city: string, state: string, postalCode: string, countryCode: string, isResidential: boolean, contactName?: string | null, companyName?: string | null, phone?: string | null, email?: string | null } | null, operatingHours?: Array<{ __typename?: 'OperatingHours', dayOfWeek: DayOfWeek, openTime?: string | null, closedTime?: string | null, isClosed: boolean }> | null } | null };
...
export type GetRegisteredParcelsQuery = { __typename?: 'Query', registeredParcels: Array<{ __typename?: 'RegisteredParcel', id: string, trackingNumber: string, status: string, serviceType: string, weight: number, weightUnit: string, parcelType?: string | null, createdAt: string, zoneName?: string | null }> };
...
export type RegisterParcelMutation = { __typename?: 'Mutation', registerParcel: { __typename?: 'RegisteredParcel', id: string, trackingNumber: string, status: string, serviceType: string, weight: number, weightUnit: string, length: number, width: number, height: number, dimensionUnit: string, declaredValue: number, currency: string, description?: string | null, parcelType?: string | null, estimatedDeliveryDate: string, createdAt: string, zoneId: string, zoneName?: string | null, depotId: string, depotName?: string | null } };
